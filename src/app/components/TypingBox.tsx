...
interface TypingBoxProps {
  initialText?: string;
  onStatsUpdate: (stats: { keyCount: number; typingTime: number }) => void;
  isTracking: boolean;
}

const IDLE_TIMEOUT = 3000; // 3초

const TypingBox: React.FC<TypingBoxProps> = ({ initialText = '', onStatsUpdate, isTracking }): React.ReactNode => {
