...
import { type MemorySettings } from '../utils/memory-settings-manager';

// ProcessingMode 타입 정의
type ProcessingMode = 'auto' | 'normal' | 'cpu-intensive' | 'gpu-intensive';
...
const DEFAULT_MEMORY_SETTINGS: MemorySettings = {
  ...
  useHardwareAcceleration: false, // 기본값은 비활성화
  useMemoryPool: true,
